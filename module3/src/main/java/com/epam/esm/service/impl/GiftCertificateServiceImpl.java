...
public class GiftCertificateServiceImpl implements GiftCertificateService {
  ...
  public GiftCertificate getCertificateById(Long id)
    ...
    giftCertificate.get().setTags(tagService.getTagsByCertificateId(giftCertificate.get().getId()));
  ...
  public GiftCertificate createCertificate(GiftCertificate giftCertificate)
    ...
    } catch (TagServiceException | GiftCertificateNotFoundException e) {
  ...
  public List<GiftCertificate> getCertificateByTagName(String tagName) {
    ...
    giftCertificates.forEach(giftCertificate -> giftCertificate
        .setTags(tagService.getTagsByCertificateId(giftCertificate.getId())));
    return giftCertificates;
  }
